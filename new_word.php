	...
	<form name="newword" class="validate" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		...
		<table class="tab3" cellspacing="0" cellpadding="5">
			<tr>
				...
				<td class="td1">\
					<input <?php echo $scrdir; ?> class="notempty setfocus checkoutsidebmp" data_info="New Term" type="text" name="WoText" id="wordfield" value="" maxlength="250" size="35" />
			...
			<tr>
				...
				<td class="td1">
					<textarea class="textarea-noreturn checklength checkoutsidebmp" data_maxlength="500" data_info="Translation" name="WoTranslation" cols="35" rows="3"></textarea>
				</td>
			</tr>
			<tr>
